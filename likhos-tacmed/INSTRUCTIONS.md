...
Drop `likhos-tacmed.zip` into your game's `mods/` folder. On a default Steam install:
...
To uninstall simply delete `likhos-tacmed.zip` from the `mods/` folder and relaunch the game.
